...
export const LeafIcon: React.FC<IconProps> = ({ className }) => (
  <svg
    ...
    className={className}
  >
    <path d="M17 8C8 10 5.9 16.17 3.82 21.34l1.89.66c.47-1.33.9-2.61 1.3-3.82l.88 1.88 1.88-.88-.88-1.88c1.21-.4 2.5-1.85 3.82-1.3l.66 1.89 1.89-.66L17 8z" />
    <path d="M17 8a4 4 0 00-4-4 4 4 0 00-4 4 4 4 0 004 4 4 4 0 004-4z" />
  </svg>
);
...
export const SproutIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M7 20h10" />
        <path d="M12 20V4" />
        <path d="M12 4H8c-1.66 0-3 1.34-3 3s1.34 3 3 3h4" />
        <path d="M12 4h4c1.66 0 3 1.34 3 3s-1.34 3-3 3h-4" />
    </svg>
);
...
export const WalletIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M21 12V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h12" />
      <path d="M16 12a2 2 0 1 0 0 4 h 5 v -4 h -5 z" />
    </svg>
);
...
export const SparklesIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="m12 3 -1.912 5.813 a2 2 0 0 1 -1.275 1.275 L3 12 l5.813 1.912 a2 2 0 0 1 1.275 1.275 L12 21 l1.912 -5.813 a2 2 0 0 1 1.275 -1.275 L21 12 l-5.813 -1.912 a2 2 0 0 1 -1.275 -1.275 L12 3 Z"/>
        <path d="M5 3v4"/>
        <path d="M19 17v4"/>
        <path d="M3 5h4"/>
        <path d="M17 19h4"/>
...
export const RecycleIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M7 19v-4l-4 4 4 4" />
      <path d="M11 5v4l4-4-4-4" />
      <path d="M3 13h18" />
...
// FIX: This line was syntactically incorrect and causing redeclaration errors. It has been removed.
// The aliased export `CheckCircleIconAdmin` is not used anywhere in the app.
// If an alias is needed in the future, it should be done with `export { CheckCircleIcon as CheckCircleIconAdmin };`
