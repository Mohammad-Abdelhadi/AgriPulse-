...
export const LeafIcon: React.FC<IconProps> = ({ className }) => (
  <svg
    ...
    className={className}
  >
    <path d="M11 20A7 7 0 0 1 4 13V7a1 1 0 0 1 1-1h1a1 1 0 0 1 1 1v1h1a1 1 0 0 1 1 1v1h1a1 1 0 0 1 1 1v7h-4a1 1 0 0 1-1-1v-1H9v1a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1v-1H5v1a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1v-1H1v1a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1v-1h-1a1 1 0 0 1-1-1V7a7 7 0 0 1 14 0v7a1 1 0 0 1-1 1h-1a1 1 0 0 1-1-1v-1h-1a1 1 0 0 1-1-1v-1h-1a1 1 0 0 1-1-1v-1h-1z" />
    <path d="M12 18a4 4 0 0 0 4-4h-4V7a4 4 0 0 0-4 4h4v7z" />
  </svg>
);
...
export const WalletIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <path d="M16 12a2 2 0 1 0 0 4h5v-4h-5z" />
    </svg>
);
...
export const RecycleIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <path d="M3 13h12a2 2 0 0 0 2-2V8" />
      <path d="M17 5h-2a2 2 0 0 0-2 2v4h4" />
      <path d="M21 13v2a2 2 0 0 1-2 2H7" />
    </svg>
);
